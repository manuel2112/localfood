...
*/
$autoload['libraries'] = array('session', 'database', 'layout', 'form_validation', 'user_agent', 'MY_PHPMailer', 'Excel','pagination','ciqrcode');
...
*/
$autoload['helper'] = array('url', 'form', 'string', 'text', 'texto_helper', 'email_helper', 'fecha_helper', 'pagination_helper', 'timeout_helper', 'random_helper', 'horario_helper', 'number_helper', 'password_helper');
...
*/
$autoload['model'] = array('login_model', 'admin_model', 'empresa_model', 'ciudad_model');
