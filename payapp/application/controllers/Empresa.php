	...
	public function indexajax()
	{
		...
		if( count($empresas) > 0 ){
			foreach( $empresas as $item )
			{
				...
				$botones .=  "<button class='btn btn-warning btnGetEditarEmpresa' idempresa='".$item->EMPRESA_ID."' data-toggle='modal' data-target='#modalEditarEmpresa' title='EDITAR EMPRESA' data-toggle='popover' data-trigger='hover' data-placement='top' data-content='Now hover out.'><i class='fa fa-pencil fa-lg'></i></button>";
