        ...
        <div class="modal-body">
        	...
        	<div class="row">
        		...
        		<div class="col-12">
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon" data-toggle="tooltip" data-placement="top" title="INGRESO"><i class="fa fa-plus"></i></span>
							<input type="text" class="form-control" name="txtEditIngreso" id="txtEditIngreso" placeholder="INGRESO..." readonly>
						</div>
					</div>
				</div>
