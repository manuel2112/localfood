					...
					<div class="row">
						<div class="col">
							<div class="form-group">              
								<div class="input-group">              
									<span class="input-group-addon"><i class="fa fa-plus"></i></span>
									<select class="form-control" id="cmbDiaInicio" name="cmbDiaInicio" required>
										<option value="">DÍA INICIO (*)...</option>
										<?php foreach( $dias as $itemDia){?>
											<option value="<?php echo $itemDia->DIA_ID?>"><?php echo $itemDia->DIA_NOMBRE?></option>
										<?php }?>
									</select>
								</div>
							</div>
					...
					<div class="row">
						<div class="col">
							<div class="form-group">              
								<div class="input-group">              
									<span class="input-group-addon"><i class="fa fa-plus"></i></span>
									<select class="form-control" id="cmbDiaCierre" name="cmbDiaCierre" required>
						...
						<div class="col">
							<div class="form-group">              
								<div class="input-group">              
									<span class="input-group-addon"><i class="fa fa-plus"></i></span>
									<select class="form-control" id="cmbHoraCierre" name="cmbHoraCierre" required>
										<option value="">HORA CIERRE (*)...</option>
										<?php 
											for( $i = 0 ; $i < 24 ; $i++ ){
												$hora = $i < 10 ? '0'.$i.':00:00' : $i.':00:00' ;
												echo '<option value="'.$hora.'">'.$hora.'</option>';
...
<div id="modalInsertFoto" class="modal fade" role="dialog">  
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
			<h4 class="modal-title">Imágenes de Promoción - <span id="verNmbEmpresaFoto"></span></h4>
			<button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-body">
        	...
        	<div class="row">
        		<div class="col-12 col-md-8">
					...
					<form role="form" method="post">
        				<div id="fotoingresado" class="text-center"></div>

						<input type="hidden" name="idEmpresaFoto" id="idEmpresaFoto">

						<div class="form-group">
							<div class="panel">IMAGEN DE PROMOCIÓN</div>
							<input type="file" class="nuevaFotoPromo" name="nuevaFotoPromo" id="nuevaFotoPromo">
							<p class="help-block">Peso máximo de la foto 512KB</p>
							<img src="<?php echo base_url('public/images/food-defecto.png')?>" class="img-thumbnail previsualizarEmpresa" width="100px">
						</div>
						...
						<div class="row mt-3">
							<div class="col-12 text-right">
								<button type="button" class="btn btn-primary" id="guardarFoto">Guardar Foto</button>
							</div>
						</div>
